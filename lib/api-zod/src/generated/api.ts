...
export const ListShotsResponse = zod.object({
  ...
  "brewMethod": zod.string().nullish().describe('How the beverage was extracted (e.g. Espresso, Pour-over, AeroPress). Independent of Drink Type (what was served).'),
