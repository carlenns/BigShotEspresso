...
- [Neon Postgres Rehearsal Report](implementation/neon-postgres-rehearsal-report.md) — completed disposable Neon migration, bootstrap, read-only API runtime, and full CSV import rehearsal evidence with remaining shot-workflow/backup blockers.
