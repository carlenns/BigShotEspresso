      ...
      for (const r of records) {
        ...
        try {
          ...
          const vals = {
            ...
            roastDateUsed: str(findField(f, ["Roast Date Used"])),
            estimatedRoastWindow: str(findField(f, ["Estimated Roast Window"])),
            actualRoastDate: str(findField(f, ["Actual Roast Date"])),
            estimatedRoastDate: str(findField(f, ["Estimated Roast Date"])),
            freshnessDatingMethod: str(findField(f, ["Freshness Dating Method"])),
            roastDateConfidence: str(findField(f, ["Roast Date Confidence"])),
            roastDateNotes: str(findField(f, ["Roast Date Notes"])),
